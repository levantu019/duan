...
class DiemNVDH(models_gis.Model):
    ...
    geoDiem = models_gis.MultiPointField(verbose_name='Điểm')
...
class TuyenNVDH(models_gis.Model):
    ...
    geoTuyen = models_gis.MultiLineStringField(verbose_name='Tuyến')
...
class VungNVDH(models_gis.Model):
    ...
    geoVung = models_gis.MultiLineStringField(verbose_name='Vùng')
...
class DonVi(models_gis.Model):
    ...
    geoDV = models_gis.MultiPointField(verbose_name='Vị trí')
...
class PhuongAnViTri(models_gis.Model):
    ...
    geoPAVT = models_gis.MultiPointField(verbose_name='Vị trí')
...
class PheDuyetPhuongAnViTri(models_gis.Model):
    ...
    geoCMPAVT = models_gis.MultiPointField(verbose_name='Góp ý', null=True, blank=True)
...
class PhuongAnTuyen(models_gis.Model):
    ...
    geoPATuyen = models_gis.MultiPointField(verbose_name='Tuyến đường')
...
class PheDuyetPhuongAnTuyen(models_gis.Model):
    ...
    geoCMPATuyen = models_gis.MultiPointField(verbose_name='Góp ý', null=True, blank=True)
...
class PhuongAnVung(models_gis.Model):
    ...
    geoPAVung = models_gis.MultiPointField(verbose_name='Tuyến đường')
...
class PheDuyetPhuongAnVung(models_gis.Model):
    ...
    geoCMPAVung = models_gis.MultiPointField(verbose_name='Góp ý', null=True, blank=True)
    paTuyen = models_gis.ForeignKey(PhuongAnVung, on_delete=models_gis.CASCADE, related_name='fk_pdpav_pavt', verbose_name='Phương án vùng')
...
class GanLucLuong(models_gis.Model):
    ...
    thoiGianKetThuc = models_gis.DateTimeField(verbose_name='Thời gian kết thúc', null=True, blank=True)
    trangThaiLL = models_gis.IntegerField(verbose_name='Trạng thái lực lượng')
